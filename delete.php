...
$Delete = mysqli_query($con, "DELETE from games where Id = '$Id'"); // This is the delete query.

if ($Delete)
{
    mysqli_close($con);
    header("location:Game Year.php"); // This makes sure that the website redirects back to itself and shows the info is deleted
    exit;
}
else
{
